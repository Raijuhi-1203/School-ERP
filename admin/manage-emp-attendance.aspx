<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/admin.master" CodeFile="manage-emp-attendance.aspx.cs" Inherits="admin_manage_emp_attendance" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapsetwo" style="text-decoration: none">Manage Employee Attendance</a>
                    </h4>
                </div>
                                        ...
                                        <asp:Repeater ID="rpt_data" runat="server">
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%# Eval("employee_name") %> (<%# Eval("employee_id") %>)
                                                    </td>
                                                    <td>
                                                        <%# Eval("status") %> 
                                                    </td>

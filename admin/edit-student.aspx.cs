...
public partial class auth_edit_delivery_boy : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack)
        {
            ...
            SqlDataReader get_data = mst.Select_Operation("Select * from student where student_id='"+Request.QueryString[0]+"' ");
            if(get_data.Read())
            {
                ...
                txtx_mother.Text = get_data["mother_name"].ToString();
    ...
    protected void btnsaveAndnext_ServerClick(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                int success = bnc.Edit_Student(txt_name.Text, txt_mobileno.Text, txt_father.Text, txtx_mother.Text, txt_address_line_1.Text, dbl_state.SelectedItem.Text, dbl_city.SelectedItem.Text, txt_pincode.Text, dbl_status.SelectedValue, dblclass.SelectedItem.Text, dblsection.SelectedItem.Text,Request.QueryString[0]);

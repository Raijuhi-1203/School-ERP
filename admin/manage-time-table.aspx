<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/admin.master" CodeFile="manage-time-table.aspx.cs" Inherits="admin_manage_time_table" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapsetwo" style="text-decoration: none">Manage Time-Table</a>
                    </h4>
                </div>
                                        ...
                                        <asp:Repeater ID="rpt_data" runat="server">
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="link-primary" href="edit-time-table.aspx?ref=<%#  Eval("id") %>" title="Edit"><i class="fa fa-edit"></i></a>

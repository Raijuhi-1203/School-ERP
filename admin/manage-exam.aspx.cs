...
public partial class admin_manage_exam : System.Web.UI.Page
{
    ...
    {
        rptbinddata.DataSource = GetData("SELECT * FROM exam");
    ...
    protected void rptbinddata_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("btndelete"))
        {
            ...
            string query_delete_service = "delete from exam where id='" + lbldeletecategoryid.Text + "'";

...
public partial class admin_manage_class_fee : System.Web.UI.Page
{
    ...
    {
        rptbinddata.DataSource = GetData("SELECT * FROM class_fee");
    ...
    protected void rptbinddata_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("btndelete"))
        {
            ...
            string query_delete_service = "delete from class_fee where id='" + lbldeletecategoryid.Text + "'";

...
public partial class auth_manage_delivery_boy : System.Web.UI.Page
{
    ...
    {
        rptbinddata.DataSource = mst.GetData("SELECT * FROM student order by id asc");
    ...
    protected void rptbinddata_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("btndelete"))
        {
            ...
            SqlDataReader dr_delete_boy = mst.Delete_Operation("delete from student where student_id='" + lbldeletedelivery_boy_id.Text + "'");
            dr_delete_boy.Close();
